  ...
  render() {
    return (
      <fieldset className="form-group mb-4">
        <label className="text-muted lead">
          {capitalize(this.props.label)}
        </label>
        <div className="pl-4 py-2 border-left border-primary">
          ...
          <label className="text-muted">Add a…</label>
